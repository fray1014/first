...
namespace SpectrumToolset
{
    public partial class DrawRect : Form
    {
        ...
        /*
        public DrawRect(ColorConfig _colorconfig)
        {
            InitializeComponent();
            rectFRoiTotalPoints = 0;
        ...
        */
                ...
                else
                {
                    ...
                    for (int i = 0; i < 4; i++)
                    {
                        if (broi[i])
                        {
                            ...
                            //    Temp = RectConverter.GenerateTaskDesc(colorconfig.location, setnames[i], tdscs[i]);
                            //}
                            //else
                            //{
                            ...
                            Temp = RectConverter.GenerateTaskDesc(monoconfig.location, setnames[i],
        ...
        private void btnSetName_Click(object sender, EventArgs e)
        {
            ...
            DrawRectSetName setNameForm = new DrawRectSetName(monoconfig.location, monoconfig.name, broi, setnames);
        ...
        private void btnImportTask_Click(object sender, EventArgs e)
        {
            ...
            ofd.InitialDirectory = monoconfig.location;
