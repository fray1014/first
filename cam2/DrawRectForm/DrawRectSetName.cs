...
namespace SpectrumToolset
{
    public partial class DrawRectSetName : Form
    {
        ...
        public DrawRectSetName(string filedir, string filename, bool[] choices, string[] names)
        {
            InitializeComponent();
            thisForm = this;
            ...
            {
                allPass[i] = false;
                defaultnames[i] = defaultname + "-" + i.ToString();
                setnames[i] = names[i];
            }
        }
        ...
        private void DrawRectSetName_Load(object sender, EventArgs e)
        {
            ...
            if (choices[0]) slideName1.Text = setnames[0];
            if (choices[1]) slideName2.Text = setnames[1];
            if (choices[2]) slideName3.Text = setnames[2];
            if (choices[3]) slideName4.Text = setnames[3];
        ...
        private void slideName1_TextChanged(object sender, EventArgs e)
        {
            if (choices[0])
            {
                ...
                if (allPass[0]) pictureBox1.Image = signicon.cross;
                else
                    pictureBox1.Image = signicon.sign;
            }
        }
        ...
        private void slideName2_TextChanged(object sender, EventArgs e)
        {
            if (choices[1])
            {
                ...
                if (allPass[1]) pictureBox2.Image = signicon.cross;
                else
                    pictureBox2.Image = signicon.sign;
            }
        }
        ...
        private void slideName3_TextChanged(object sender, EventArgs e)
        {
            if (choices[2])
            {
                ...
                if (allPass[2]) pictureBox3.Image = signicon.cross;
                else
                    pictureBox3.Image = signicon.sign;
            }
        }
        ...
        private void slideName4_TextChanged(object sender, EventArgs e)
        {
            if (choices[3])
            {
                ...
                if (allPass[3]) pictureBox4.Image = signicon.cross;
                else
                    pictureBox4.Image = signicon.sign;
            }
        }
